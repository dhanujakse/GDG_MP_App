...
const SEED_COMPLAINTS: Complaint[] = [
  {
    ...
    photos: [{ id: "ph_001", url: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400", thumbnailUrl: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=200", uploadedAt: "2024-07-01T08:00:00Z", uploadedBy: "ctz_001" }],
    citizensJoined: 23,
    joinedCitizenIds: [],
    reportedBy: "ctz_001",
